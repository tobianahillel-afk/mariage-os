...
Lots 3–12: NOT_STARTED
Next permitted action: pass isolated `[AR006-PREFLIGHT]` on the rotated Pages token and synthetic user, then run one exact-size provider-evidence campaign after normal CI; no old-log requery
```
