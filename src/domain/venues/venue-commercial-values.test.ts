...
describe("venue commercial canonical values", () => {
  ...
  it("normalizes optional text without truncation", () => {
  ...
  it("validates strict civil dates including leap years", () => {
  ...
  it("validates local times and canonicalizes provider seconds", () => {
