...
it("recognizes frozen venue offer component vocabularies", () => {
...
it("normalizes complete venue offer component input", () => {
  expect(
    normalizeVenueOfferComponent(
      component({
        label: "  Furniture  ",
...
it("uses neutral component defaults without calculating totals", () => {
