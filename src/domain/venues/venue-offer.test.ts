...
describe("venue offer domain", () => {
  it("recognizes frozen status and tax vocabularies", () => {
  ...
  it("implements exactly the frozen offer transition graph", () => {
  ...
  it("normalizes complete commercial terms", () => {
    expect(
      normalizeVenueOfferTerms(
        terms({
          name: "  Autumn quote  ",
  ...
  it("applies canonical defaults without inventing commercial truth", () => {
  ...
  ] as const)("rejects invalid terms with %s", (draft, error) => {
