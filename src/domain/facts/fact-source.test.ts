...
describe("fact source normalization", () => {
  it("normalizes display title and timestamp without deriving evidence", () => {
  ...
  it("allows nullable optional source metadata", () => {
    expect(
      normalizeFactSource({
        ...validDraft,
        title: null,
  ...
  it("rejects malformed or empty titles", () => {
